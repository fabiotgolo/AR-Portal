...
public class Portal : MonoBehaviour
{
    ...
    public InstagramAPIIntegration InstagramAPIIntegrationScript;
    ...
    private void OnTriggerStay(Collider collider)
    {
        ...
        if (relativePosition.z<0)
        {
            ...
            InstagramAPIIntegrationScript.UpdateInstagramPictureMaterials(true);
        ...
        else
        {
            ...
            InstagramAPIIntegrationScript.UpdateInstagramPictureMaterials(false);
